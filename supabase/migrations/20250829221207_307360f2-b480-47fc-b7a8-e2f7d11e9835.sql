...
-- Drop existing types if they exist (from previous failed migration)
DROP TYPE IF EXISTS sync_status_enum CASCADE;
DROP TYPE IF EXISTS sync_job_status_enum CASCADE;
DROP TYPE IF EXISTS sync_job_type_enum CASCADE;
DROP TYPE IF EXISTS card_condition_enum CASCADE;
DROP TYPE IF EXISTS card_printing_enum CASCADE;
