-- Fix security warnings - need to handle dependent objects for pg_trgm extension
...
-- 3. For the extension warning, we'll keep pg_trgm in public schema since moving it would break indexes
-- This is acceptable for most applications and the warning is minor