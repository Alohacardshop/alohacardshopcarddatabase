-- Fix remaining security warnings - recreate views without security definer
...
-- Recreate database_stats view without security definer
...
-- Recreate popular_cards view without security definer
